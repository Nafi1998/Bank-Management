...
<div class="form">
	...
	<form action="/admin/emplist/edit/{{$bank->id}}" method="post" enctype="multipart/form-data" >
		{{csrf_field()}}
		...
		<center>
			...
			<br>
			<a style="text-decoration: none;" href="/admin/emplist/edit/picture/{{$bank->id}}">Update Profile Pictrue</a>
		</center>
		...
		<input class="form-control" type="text" name="emp_name"  value="{{$emp->empname}}">
		...
		<label>Salary</label>
		<input class="form-control" type="text" name="sal"  value="{{$emp->empsalary}}">
		@if($errors->has('sal'))
			<span class="text-danger">
		...
		<input class="form-control" type="text" name="desig"  value="{{$emp->empdesignation}}">
		@if($errors->has('desig'))
			<span class="text-danger">
		...
		<input class="form-control" type="date" name="joinDate"  value="{{$emp->joindate}}">
